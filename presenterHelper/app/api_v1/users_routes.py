...
@api.route('/register_confirm/<token>', methods=['POST'])
...
"""
 @api {post} /forget-password/:email respond to forget password request
 ...
 @apiSuccess {json} 201 message forgot message confirmation message
 @apiSuccessExample {json} 201 Success-Response:
 {
...
@api.route('/forget-password/<string:email>', methods=['POST'])
...
"""
 ...
 @apiParam {string} a token that came from server and is used to find email in server.
 @apiParamExample {json} Request-Example:
 {
    "password": "asdfgh"
 }

 @apiSuccess {json} 202 message change user password confirmation message
